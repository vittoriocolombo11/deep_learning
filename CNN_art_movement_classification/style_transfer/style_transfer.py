...
#create files
style_name = "romanticismo.jpg" # the painting from which you want to transfer the style from
target_name = "paesaggio.jpg" # the image on which you want to apply the style

style_reference_image_path = os.getcwd()+'/images/style/'+style_name 
